...
int VBF_BDT_producer(TString rootIn="VBF_test",TString myMethodList = "" )
{
  TMVA::Tools::Instance();
  ...
  // --------------------------------------------------------------------------------------------------
  TString fname_sig = "ntuples/VBF_ntuples_sig_ALL.root";
  TString fname_bkg = "ntuples/VBF_ntuples_bkg_ALL.root";
